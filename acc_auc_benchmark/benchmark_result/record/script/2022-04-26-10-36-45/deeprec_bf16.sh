...
python train.py     --bf16 --checkpoint /benchmark_result/checkpoint/2022-04-26-10-36-45/dssm_deeprec_bf16_  >/benchmark_result/log/2022-04-26-10-36-45/dssm_deeprec_bf16_.log 2>&1
